...
public abstract class Condition {
  ...
  protected <T> T resolveArgument(
    ...
    if (!argumentClass.isAssignableFrom(value.getClass())) {
      throw InvalidConditionArgumentException.invalidType(
          name, argumentClass, value.getClass(), getClass());
    }
  ...
  protected <T> T resolveContext(
    ...
    if (!contextValueClass.isAssignableFrom(value.getClass())) {
      throw InvalidContextValueException.invalidType(
          name, contextValueClass, value.getClass(), getClass());
    }
   ...
   * @return
   */
  public abstract boolean fulfills(Map<String, Object> arguments, AccessRequest request);
}
